...
# --- CONFIGURATION ---
BASE_URL = "https://dining.ucla.edu/epicuria-at-ackerman/"
DOMAIN = "https://dining.ucla.edu"
LOCATION_NAME = "Epicuria at Ackerman"
...
_OUTPUT_FILE = "data/raw/ucla_epicuria_ackerman_nutrition.csv"
    ...
    for elem in elements:
        ...
        if elem.name == 'a' and 'See Meal Details' in text:
            ...
            for excl in EXCLUDED_SECTIONS:
                if current_station.lower() == excl.lower():
                    is_excluded = True
                    break
