...
# --- CONFIGURATION ---
BASE_URL = "https://dining.ucla.edu/rendezvous/"
DOMAIN = "https://dining.ucla.edu"
LOCATION_NAME = "Rendezvous"

# KNOWN STATIONS (For Section Logic)
KNOWN_STATIONS = [
    "Rendezvous Daily Specials",
    "Asian Daily Special",
    "Asian Entrees",
    "Asian Sides",
    "Latin Daily Special",
    "Latin Build Your Own",
    "Latin Toppings Bar",
    "Salsa Bar",
    "SUSHI BOWLS", "Base", "Entrée", "ASIAN TOPPING", "ASIAN SAUCE", "BOBA DRINKS", "DRINKS", "CONDIMENTS"
]
...
_MEAL_KEYWORDS = {"BREAKFAST", "LUNCH", "DINNER", "EXTENDED DINNER", "LUNCH / DINNER", "ALL DAY"}

_OUTPUT_FILE = "data/raw/ucla_rendezvous_nutrition.csv"
