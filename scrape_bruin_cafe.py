...
# --- CONFIGURATION ---
BASE_URL = "https://dining.ucla.edu/bruin-cafe/"
DOMAIN = "https://dining.ucla.edu"
LOCATION_NAME = "Bruin Cafe"
...
_OUTPUT_FILE = "data/raw/ucla_bruin_cafe_nutrition_final.csv"
...
def get_menu_links():
    ...
    print(f"Found {len(menu_items)} items (Filtered).")
    return menu_items
