...
# --- CONFIGURATION ---
BASE_URL = "https://dining.ucla.edu/epicuria-at-covel/"
DOMAIN = "https://dining.ucla.edu"
LOCATION_NAME = "Epicuria at Covel"

# KNOWN STATIONS (Exact names as they appear on the site headers)
KNOWN_STATIONS = [
    "Capri",
    "Psistaris",
    "Alimenti",
...
_OUTPUT_FILE = "data/raw/ucla_epicuria_final_cleaned.csv"
...
def get_menu_links():
    ...
    for elem in elements:
        ...
        if elem.name == 'a' and 'See Meal Details' in text:
            ...
            # A. Global Exclusion: Always skip Salad Bar
            if "Salad Bar" in current_station:
                continue

            # B. Lunch Exclusion: Skip "Capri" station during Lunch
            if current_meal == "Lunch" and current_station == "Capri":
                continue
